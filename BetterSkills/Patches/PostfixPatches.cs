...
namespace BetterSkills.Patches {
    ...
    class PostfixPatches {
        ...
        public static void InitializeAll(DefaultSkillEffects __instance) {
            ...
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.OneHandedSpeedValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectOneHandedDamage(__instance).Initialize(new TextObject("{=baUFKAbd}One handed weapon damage: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.OneHanded
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.OneHandedDamageValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectTwoHandedSpeed(__instance).Initialize(new TextObject("{=Np94rYMz}Two handed weapon speed: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.TwoHanded
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.TwoHandedSpeedValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectTwoHandedDamage(__instance).Initialize(new TextObject("{=QkbbLb4v}Two handed weapon damage: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.TwoHanded
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.TwoHandedDamageValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectPolearmSpeed(__instance).Initialize(new TextObject("{=2ATI9qVM}Polearm weapon speed: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Polearm
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.PolearmSpeedValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectPolearmDamage(__instance).Initialize(new TextObject("{=17cIGVQE}Polearm weapon damage: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Polearm
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.PolearmDamageValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectBowLevel(__instance).Initialize(new TextObject("{=XN7BX0qP}Max usable bow difficulty: {a0}", null), new SkillObject[]
            {
                DefaultSkills.Bow
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.BowLevelValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectBowDamage(__instance).Initialize(new TextObject("{=RUZHJMQO}Bow Damage: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Bow
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.BowDamageValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectBowAccuracy(__instance).Initialize(new TextObject("{=sQCS90Wq}Bow Accuracy: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Bow
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.BowAccuracyValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectThrowingSpeed(__instance).Initialize(new TextObject("{=Z0CoeojG}Thrown weapon speed: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Throwing
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.ThrowingSpeedValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectThrowingDamage(__instance).Initialize(new TextObject("{=TQMGppEk}Thrown weapon damage: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Throwing
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.ThrowingDamageValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectThrowingAccuracy(__instance).Initialize(new TextObject("{=SfKrjKuO}Thrown weapon accuracy: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Throwing
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.ThrowingAccuracyValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.CrossbowReloadSpeedValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectCrossbowAccuracy(__instance).Initialize(new TextObject("{=JwWnpD40}Crossbow accuracy: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Crossbow
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.CrossbowAccuracyValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectHorseLevel(__instance).Initialize(new TextObject("{=8uBbbwY9}Max mount difficulty: {a0}", null), new SkillObject[]
            {
                DefaultSkills.Riding
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.HorseLevelValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectHorseSpeed(__instance).Initialize(new TextObject("{=Y07OcP1T}Horse speed: +{a0}", null), new SkillObject[]
            {
                DefaultSkills.Riding
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.HorseSpeedValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectHorseManeuver(__instance).Initialize(new TextObject("{=AahNTeXY}Horse maneuver: +{a0}", null), new SkillObject[]
            {
                DefaultSkills.Riding
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.HorseManeuverValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            {
                DefaultSkills.Riding
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.MountWeaponDamagePenaltyValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 20f, 0f);
            ...
            {
                DefaultSkills.Riding
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.MountWeaponSpeedPenaltyValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 30f, 0f);
            ...
            {
                DefaultSkills.Riding
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.DismountResistanceValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 40f, 0f);
            ...
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.AthleticsSpeedFactorValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            {
                DefaultSkills.Athletics
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.AthleticsWeightFactorValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            {
                DefaultSkills.Athletics
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.KnockBackResistanceValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 15f, 0f);
            ...
            {
                DefaultSkills.Athletics
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.KnockDownResistanceValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 40f, 0f);
            ...
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.SmithingLevelValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectTacticsAdvantage(__instance).Initialize(new TextObject("{=XO3SOlZx}Simulation advantage: +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Tactics
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.TacticsAdvantageValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            {
                DefaultSkills.Tactics
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.TacticsTroopSacrificeReductionValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            _effectTrackingRadius(__instance).Initialize(new TextObject("{=kqJipMqc}Track detection radius +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Scouting
            }, SkillEffect.PerkRole.Scout, BetterSkills.Settings.TrackingRadiusValue, SkillEffect.PerkRole.None, 0.05f, SkillEffect.EffectIncrementType.Add, 0f, 0f);
            ...
            {
                DefaultSkills.Scouting
            }, SkillEffect.PerkRole.Scout, BetterSkills.Settings.TrackingLevelValue, SkillEffect.PerkRole.None, 1f, SkillEffect.EffectIncrementType.Add, 0f, 0f);
            _effectTrackingSpottingDistance(__instance).Initialize(new TextObject("{=lbrOAvKj}Spotting distance +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Scouting
            }, SkillEffect.PerkRole.Scout, BetterSkills.Settings.TrackingSpottingDistanceValue, SkillEffect.PerkRole.None, 0.03f, SkillEffect.EffectIncrementType.Add, 0f, 0f);
            ...
            {
                DefaultSkills.Scouting
            }, SkillEffect.PerkRole.Scout, BetterSkills.Settings.TrackingTrackInformationValue, SkillEffect.PerkRole.None, 0.03f, SkillEffect.EffectIncrementType.Add, 0f, 0f);
            _effectRogueryLootBonus(__instance).Initialize(new TextObject("{=bN3bLDb2}Battle Loot +{a0}%", null), new SkillObject[]
            {
                DefaultSkills.Roguery
            }, SkillEffect.PerkRole.PartyLeader, BetterSkills.Settings.RogueryLootBonusValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            {
                DefaultSkills.Charm
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.CharmRelationBonusValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            {
                DefaultSkills.Trade
            }, SkillEffect.PerkRole.PartyLeader, BetterSkills.Settings.TradePenaltyReductionValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.LeadershipMoraleBonusValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 0f, 0f);
            ...
            {
                DefaultSkills.Leadership
            }, SkillEffect.PerkRole.Personal, BetterSkills.Settings.LeadershipGarrisonSizeBonusValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 0f, 0f);
            ...
            }, SkillEffect.PerkRole.Surgeon, BetterSkills.Settings.SurgeonSurvivalBonusValue, SkillEffect.PerkRole.None, 0.01f, SkillEffect.EffectIncrementType.Add, 0f, 0f);
            ...
            {
                DefaultSkills.Medicine
            }, SkillEffect.PerkRole.Surgeon, BetterSkills.Settings.HealingRateBonusForHeroesValue, SkillEffect.PerkRole.None, 0.05f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            {
                DefaultSkills.Medicine
            }, SkillEffect.PerkRole.Surgeon, BetterSkills.Settings.HealingRateBonusForRegularsValue, SkillEffect.PerkRole.None, 0.05f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            {
                DefaultSkills.Medicine
            }, SkillEffect.PerkRole.Governor, BetterSkills.Settings.GovernorHealingRateBonusValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            }, SkillEffect.PerkRole.Engineer, BetterSkills.Settings.SiegeEngineProductionBonusValue, SkillEffect.PerkRole.None, 0.05f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            {
                DefaultSkills.Engineering
            }, SkillEffect.PerkRole.Governor, BetterSkills.Settings.TownProjectBuildingBonusValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.AddFactor, 0f, 0f);
            ...
            }, SkillEffect.PerkRole.Quartermaster, BetterSkills.Settings.StewardPartySizeBonusValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 0f, 0f);
            ...
            {
                DefaultSkills.Engineering
            }, SkillEffect.PerkRole.Engineer, BetterSkills.Settings.EngineerLevelValue, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 0f, 0f);
        }
	}
}
