...
namespace BetterSkills.Patches
{
    ...
    class PostfixPatches
    {
        ...
        public static void InitializeAll(DefaultSkillEffects __instance)
        {
            ...
            _effectBowLevel(__instance).Initialize(
                new TextObject("{=XN7BX0qP}Max usable bow difficulty: {a0}", null),
                DefaultSkills.Bow,
                PartyRole.Personal,
                BetterSkills.Settings.BowLevelValue,
            ...
            _effectHorseLevel(__instance).Initialize(
                new TextObject("{=8uBbbwY9}Max mount difficulty: {a0}", null),
                DefaultSkills.Riding,
                PartyRole.Personal,
                BetterSkills.Settings.HorseLevelValue,
                EffectIncrementType.Add);
            ...
            _effectTrackingLevel(__instance).Initialize(
                new TextObject("{=aGecGUub}Max track difficulty that can be detected: {a0}", null),
                DefaultSkills.Scouting,
                PartyRole.Scout,
                BetterSkills.Settings.TrackingLevelValue,
                EffectIncrementType.Add);
            ...
            _effectEngineerLevel(__instance).Initialize(
                new TextObject("{=aQduWCrg}Max difficulty of siege engine that can be built: {a0}", null),
                DefaultSkills.Engineering,
                PartyRole.Engineer,
                BetterSkills.Settings.EngineerLevelValue,
                EffectIncrementType.Add);
        }
    }
